...
@Getter
@Builder
@Schema(description = "공유 레포지토리 입장 성공 응답 DTO")
public class RepositoryJoinResponse {
    ...
    @Schema(description = "공유 링크", example = "https://webide.app/repositories/1")
    private String shareLink;

    @Schema(description = "생성일시", example = "2025-07-18T13:10:00Z")
    private LocalDateTime createdAt;

    @Schema(description = "수정일시", example = "2025-07-22T13:10:00Z")
